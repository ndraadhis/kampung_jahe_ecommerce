        ...
        <div class="div_deg">
          <table class="table_deg">
            ...
            <tr>
              ...
              <td>
                <img height="120" width="120" src="<?php echo e(asset('products/'.$products->image)); ?>">
              </td>
              <td>
                <a class="btn btn-success" href="<?php echo e(url('update_product', $products->id)); ?>">Edit</a>
              </td>
              <td>
...
<?php /**PATH E:\Kampung_Jahe_Ecommerce\resources\views/admin/view_product.blade.php ENDPATH**/ ?>